...
export const MarketingLayout = ({ children }: MarketingLayoutProps) => {
  ...
  const navItems = [
    { label: tf("website.nav.matches", "Matches"), to: "/matches" },
    { label: tf("website.nav.leagues", "Leagues"), to: "/leagues" },
    { label: tf("website.nav.how", "How it works"), to: "/how-it-works" },
    { label: tf("website.nav.pricing", "Pricing"), to: "/pricing" },
  ];
        ...
        <div className="max-w-6xl mx-auto px-5 py-14 grid gap-10 md:grid-cols-12">
          ...
          <div className="md:col-span-2">
            <h4 className="text-[11px] font-bold uppercase tracking-widest text-white mb-4">
              {tf("website.footer.browse", "Browse")}
            </h4>
            <ul className="space-y-2.5 text-sm">
              ...
              <li><Link to="/how-it-works" className="hover:text-[#2ECC71] transition-colors">{tf("website.footer.how", "How it works")}</Link></li>
          ...
          <div className="md:col-span-3">
            <h4 className="text-[11px] font-bold uppercase tracking-widest text-white mb-4">
              {tf("website.footer.editorial", "Editorial")}
            </h4>
            <ul className="space-y-2.5 text-sm">
