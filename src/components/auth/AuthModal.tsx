  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle>Create your account in seconds</DialogTitle>
          <DialogDescription>
            {reason ? `Sign in ${reason}.` : "No spam. Only useful alerts."}
          </DialogDescription>
        </DialogHeader>
        ...
        {mode === "magic" ? (
          magicSent ? (
            <div className="rounded-xl border border-[#2ECC71]/30 bg-[#2ECC71]/5 p-4 text-center">
              <p className="text-sm font-bold text-[#2C3E50]">Check your email ✉️</p>
              <p className="text-xs text-[#2C3E50]/65 mt-1">
          ...
          <Tabs value={tab} onValueChange={(v) => setTab(v as "signin" | "signup")}>
            ...
            <button
              ...
              className="text-[11px] text-muted-foreground hover:text-foreground underline-offset-2 hover:underline mt-2 mx-auto block"
            >
