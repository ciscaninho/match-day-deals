          ...
          {list.map((s) => {
            ...
            return (
              <Link
                key={s.slug}
                to={`/stadiums/${s.slug}`}
                className="group relative rounded-2xl overflow-hidden border border-slate-200 bg-gradient-to-br from-[#2ECC71]/20 to-indigo-500/20 aspect-[4/5] hover:-translate-y-0.5 hover:shadow-xl transition-all"
              >
                {bg && (
